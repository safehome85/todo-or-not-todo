...
CSV_FILENAME = os.path.join(SCRIPT_DIR, 'products1.csv')

# Поля для CSV файла
CSV_FIELDNAMES = [
    'Название', 'Цена', 'Розница', 'Категория', 'Артикул', 'Описание',
    'Характеристики', 'Количество', 'Изображение'
]
...
def format_specs_as_html(specs_string):
    """ Преобразует строку характеристик, разделенную точкой с запятой, в HTML-код в виде маркированного списка. """
            ...
            if per_page > 0:
                ...
                if total_pages > 1:
                    ...
                    for page_num in range(2, total_pages + 1):
                        ...
                        try:
                            next_page_response = session.get(page_url, timeout=30)
